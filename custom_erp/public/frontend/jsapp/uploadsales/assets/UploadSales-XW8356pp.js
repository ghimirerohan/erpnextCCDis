...
import { m as commonjsGlobal, l as call } from "./ui-Ca38NmEL.js";
import { g as ref, o as openBlock, a as createElementBlock, ad as createStaticVNode, b as createBaseVNode, t as toDisplayString, N as withModifiers, n as normalizeClass, e as createCommentVNode, I as createTextVNode, F as Fragment, M as renderList, k as onMounted, L as unref, y as createBlock } from "./vendor-BMb8bgkN.js";
...
const _hoisted_2$4 = { class: "space-y-4" };
const _hoisted_3$4 = { class: "text-lg font-medium text-gray-900" };
const _hoisted_4$4 = {
  key: 0,
  class: "mt-4 p-4 bg-red-50 border border-red-200 rounded-lg"
};
const _hoisted_5$4 = { class: "text-sm text-red-800" };
const _sfc_main$5 = {
  __name: "UploadArea",
  emits: ["file-uploaded"],
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1$5, [
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_2$4, [
            ...
            createBaseVNode("div", null, [
              createBaseVNode("p", _hoisted_3$4, toDisplayString(dragOver.value ? "Drop your CSV file here" : "Drag and drop your CSV file here"), 1),
        ...
        error.value ? (openBlock(), createElementBlock("div", _hoisted_4$4, [
          createBaseVNode("p", _hoisted_5$4, toDisplayString(error.value), 1)
...
const _hoisted_2$3 = { class: "grid grid-cols-1 md:grid-cols-2 gap-6" };
        ...
        createBaseVNode("div", _hoisted_2$3, [
          createBaseVNode("div", null, [
            ...
            createBaseVNode("select", {
              ...
              createBaseVNode("option", _hoisted_4$3, toDisplayString(__props.loadingDrivers ? "Loading drivers..." : "Select a driver"), 1),
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.drivers, (driver) => {
                return openBlock(), createElementBlock("option", {
                  key: driver.name,
                  value: driver.name
                }, toDisplayString(driver.employee_name || driver.name), 9, _hoisted_5$3);
              }), 128))
            ], 40, _hoisted_3$3),
          ...
          createBaseVNode("div", null, [
            ...
            createBaseVNode("select", {
              ...
              createBaseVNode("option", _hoisted_7$3, toDisplayString(__props.loadingVehicles ? "Loading vehicles..." : "Select a vehicle (optional)"), 1),
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.vehicles, (vehicle) => {
                return openBlock(), createElementBlock("option", {
                  key: vehicle.name,
                  value: vehicle.name
                }, toDisplayString(vehicle.license_plate ? `${vehicle.name} (${vehicle.license_plate})` : vehicle.name), 9, _hoisted_8$3);
              }), 128))
            ], 40, _hoisted_6$3),
...
const _hoisted_2$2 = { class: "flex items-center justify-between mb-6" };
const _hoisted_3$2 = { class: "flex items-center" };
const _hoisted_4$2 = { class: "text-sm text-gray-600" };
const _hoisted_5$2 = { class: "overflow-x-auto" };
const _hoisted_6$2 = { class: "min-w-full divide-y divide-gray-200" };
const _hoisted_7$2 = { class: "bg-white divide-y divide-gray-200" };
const _hoisted_8$2 = { class: "px-3 py-4 whitespace-nowrap text-sm text-gray-900" };
const _hoisted_9$2 = { class: "px-3 py-4 whitespace-nowrap text-sm text-gray-900" };
const _hoisted_10$2 = { class: "px-3 py-4 whitespace-nowrap text-sm text-gray-900 font-medium" };
const _hoisted_11$2 = { class: "px-3 py-4 whitespace-nowrap text-sm text-gray-900" };
const _hoisted_12$2 = { class: "px-3 py-4 whitespace-nowrap text-sm text-gray-900" };
const _hoisted_13$2 = { class: "px-3 py-4 whitespace-nowrap text-sm text-gray-900" };
      ...
      return openBlock(), createElementBlock("section", _hoisted_1$3, [
        createBaseVNode("div", _hoisted_2$2, [
          createBaseVNode("div", _hoisted_3$2, [
            ...
            createBaseVNode("div", null, [
              ...
              createBaseVNode("p", _hoisted_4$2, "First " + toDisplayString(__props.previewData.length) + " rows • Total " + toDisplayString(__props.totalInvoices) + " invoices", 1)
            ])
          ])
        ]),
        createBaseVNode("div", _hoisted_5$2, [
          createBaseVNode("table", _hoisted_6$2, [
            ...
            createBaseVNode("tbody", _hoisted_7$2, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.previewData, (row, index) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_8$2, toDisplayString(row["Is Return (Credit Note)"] || ""), 1),
                  createBaseVNode("td", _hoisted_9$2, toDisplayString(row["Date"] || ""), 1),
                  createBaseVNode("td", _hoisted_10$2, toDisplayString(row["ID"] || ""), 1),
                  createBaseVNode("td", _hoisted_11$2, toDisplayString(row["Customer"] || ""), 1),
                  createBaseVNode("td", _hoisted_12$2, toDisplayString(row["Item (Items)"] || ""), 1),
                  createBaseVNode("td", _hoisted_13$2, toDisplayString(row["Quantity (Items)"] || ""), 1),
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1$2, _cache[0] || (_cache[0] = [
        createStaticVNode('<div class="flex flex-col items-center justify-center py-12"><div class="flex items-center justify-center w-16 h-16 bg-indigo-100 rounded-full mb-6"><svg class="w-8 h-8 text-indigo-600 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg></div><h2 class="text-2xl font-semibold text-gray-900 mb-2">Importing Sales Invoices</h2><p class="text-gray-600 text-center max-w-md"> Please wait while we process your sales invoice data. This may take a few minutes depending on the number of invoices. </p><div class="flex space-x-1 mt-6"><div class="w-2 h-2 bg-indigo-600 rounded-full animate-bounce"></div><div class="w-2 h-2 bg-indigo-600 rounded-full animate-bounce" style="animation-delay:0.1s;"></div><div class="w-2 h-2 bg-indigo-600 rounded-full animate-bounce" style="animation-delay:0.2s;"></div></div></div>', 1)
      ]));
    };
  }
};
...
const _hoisted_27 = { class: "cursor-pointer text-red-800 font-medium hover:text-red-900" };
const _hoisted_28 = { class: "mt-2 pl-4 border-l-2 border-red-300" };
const _sfc_main$1 = {
  __name: "SummaryCard",
  props: {
    summary: {
      ...
      return openBlock(), createElementBlock("section", _hoisted_1$1, [
        ...
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3$1, [
            ...
            _cache[2] || (_cache[2] = createBaseVNode("div", { class: "text-sm text-gray-600 mt-1" }, "Total Invoices", -1))
          ]),
          createBaseVNode("div", _hoisted_5$1, [
            createBaseVNode("div", _hoisted_6$1, toDisplayString(__props.summary.imported), 1),
            _cache[3] || (_cache[3] = createBaseVNode("div", { class: "text-sm text-green-700 mt-1" }, "Successfully Imported", -1))
          ]),
          createBaseVNode("div", _hoisted_7$1, [
            createBaseVNode("div", _hoisted_8$1, toDisplayString(__props.summary.skipped), 1),
            _cache[4] || (_cache[4] = createBaseVNode("div", { class: "text-sm text-yellow-700 mt-1" }, "Skipped (Already Exist)", -1))
          ]),
          createBaseVNode("div", _hoisted_9$1, [
            createBaseVNode("div", _hoisted_10$1, toDisplayString(__props.summary.errors), 1),
            _cache[5] || (_cache[5] = createBaseVNode("div", { class: "text-sm text-red-700 mt-1" }, "Errors", -1))
          ])
        ]),
        createBaseVNode("div", _hoisted_11$1, [
          createBaseVNode("div", _hoisted_12$1, [
            createBaseVNode("div", null, [
              _cache[6] || (_cache[6] = createBaseVNode("div", { class: "text-sm text-indigo-700 font-medium" }, "Total Amount Imported", -1)),
              createBaseVNode("div", _hoisted_13$1, toDisplayString(formatAmount(__props.summary.amount)), 1)
            ]),
            _cache[7] || (_cache[7] = createBaseVNode("div", { class: "flex items-center justify-center w-16 h-16 bg-indigo-100 rounded-full" }, [
              createBaseVNode("svg", {
        ...
        createBaseVNode("div", _hoisted_14$1, [
          createBaseVNode("button", {
            ...
            createBaseVNode("span", { class: "font-semibold" }, "Import Another File", -1)
          ])),
          createBaseVNode("button", {
            onClick: _cache[1] || (_cache[1] = ($event) => _ctx.$emit("redo-import")),
        ...
        __props.summary.imported > 0 ? (openBlock(), createElementBlock("div", _hoisted_17$1, [
          createBaseVNode("div", _hoisted_18$1, [
            ...
            createBaseVNode("div", _hoisted_19$1, [
              ...
              _cache[12] || (_cache[12] = createBaseVNode("p", { class: "text-sm text-green-700 mt-1" }, " All invoices are in draft status. You can review and submit them from the Sales Invoice list. ", -1))
            ])
          ])
        ])) : createCommentVNode("", true),
        __props.summary.errors > 0 ? (openBlock(), createElementBlock("div", _hoisted_21, [
          createBaseVNode("div", _hoisted_22, [
            ...
            createBaseVNode("div", _hoisted_23, [
              ...
              _cache[14] || (_cache[14] = createBaseVNode("p", { class: "text-sm text-red-700 mt-1" }, " Download the error CSV to see details and fix the issues. ", -1)),
              __props.summary.errorDetails && __props.summary.errorDetails.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_25, [
                createBaseVNode("details", _hoisted_26, [
                  createBaseVNode("summary", _hoisted_27, " View Error Details (" + toDisplayString(__props.summary.errorDetails.length) + " errors) ", 1),
                  createBaseVNode("div", _hoisted_28, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(__props.summary.errorDetails, (error, index) => {
    ...
    function startImport() {
      return __async(this, null, function* () {
        ...
        try {
          ...
          const testResponse = yield call("custom_erp.custom_erp.api.uploadsales.test_api_v2");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("main", _hoisted_7, [
          ...
          showProgress.value ? (openBlock(), createBlock(_sfc_main$2, { key: 6 })) : createCommentVNode("", true),
          showSummary.value ? (openBlock(), createBlock(_sfc_main$1, {
            key: 7,
            summary: summary.value,
            onStartNew: resetUpload,
            onRedoImport: redoImport
...
//# sourceMappingURL=UploadSales-XW8356pp.js.map
