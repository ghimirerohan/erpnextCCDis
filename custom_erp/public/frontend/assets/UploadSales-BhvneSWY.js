...
const _hoisted_2$4 = { class: "max-w-md" };
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", _hoisted_1$4, [
        _cache[3] || (_cache[3] = createStaticVNode('<div class="flex items-center mb-6"><div class="flex items-center justify-center w-10 h-10 bg-green-100 rounded-lg mr-3"><svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg></div><h2 class="text-xl font-semibold text-gray-900">Select Driver</h2></div>', 1)),
        createBaseVNode("div", _hoisted_2$4, [
          _cache[1] || (_cache[1] = createBaseVNode("label", { class: "block text-sm font-semibold text-gray-700 mb-3" }, [
          ...
          createBaseVNode("select", {
            ...
            createBaseVNode("option", _hoisted_4$4, toDisplayString(__props.loading ? "Loading drivers..." : "Select a driver"), 1),
          ...
          _cache[2] || (_cache[2] = createBaseVNode("p", { class: "mt-2 text-sm text-gray-500" }, " This driver will be assigned to all imported sales invoices ", -1))
        ])
      ]);
    };
  }
...
const _hoisted_10$1 = { class: "bg-yellow-50 border border-yellow-200 rounded-lg p-4" };
const _hoisted_11$1 = { class: "text-2xl font-bold text-yellow-600" };
const _hoisted_12$1 = { class: "bg-red-50 border border-red-200 rounded-lg p-4" };
const _hoisted_13$1 = { class: "text-2xl font-bold text-red-600" };
      ...
      return openBlock(), createElementBlock("section", _hoisted_1$2, [
        ...
        createBaseVNode("div", _hoisted_7$2, [
          ...
          createBaseVNode("div", _hoisted_10$1, [
            createBaseVNode("div", _hoisted_11$1, toDisplayString(__props.progress.skipped), 1),
            _cache[1] || (_cache[1] = createBaseVNode("div", { class: "text-sm text-yellow-700" }, "Skipped", -1))
          ]),
          createBaseVNode("div", _hoisted_12$1, [
            createBaseVNode("div", _hoisted_13$1, toDisplayString(__props.progress.errors), 1),
...
const _hoisted_10 = { class: "text-3xl font-bold text-red-600" };
const _hoisted_11 = { class: "bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-lg p-6 mb-6" };
const _hoisted_12 = { class: "flex items-center justify-between" };
const _hoisted_13 = { class: "text-3xl font-bold text-indigo-900 mt-2" };
      ...
      return openBlock(), createElementBlock("section", _hoisted_1$1, [
        ...
        createBaseVNode("div", _hoisted_2$1, [
          ...
          createBaseVNode("div", _hoisted_9$1, [
            createBaseVNode("div", _hoisted_10, toDisplayString(__props.summary.errors), 1),
        ...
        createBaseVNode("div", _hoisted_11, [
          createBaseVNode("div", _hoisted_12, [
            createBaseVNode("div", null, [
              ...
              createBaseVNode("div", _hoisted_13, toDisplayString(formatAmount(__props.summary.amount)), 1)
            ]),
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              createBaseVNode("div", _hoisted_5, [
                _cache[3] || (_cache[3] = createBaseVNode("div", { class: "flex items-center justify-center w-12 h-12 bg-indigo-600 rounded-lg" }, [
                  createBaseVNode("svg", {
                ...
                createBaseVNode("div", null, [
                  _cache[2] || (_cache[2] = createBaseVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Upload Sales Invoices", -1)),
        ...
        createBaseVNode("main", _hoisted_7, [
          ...
          csvContent.value && !showProgress.value && !showSummary.value ? (openBlock(), createBlock(_sfc_main$4, {
            key: 1,
            modelValue: selectedDriver.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => selectedDriver.value = $event),
            drivers: drivers.value,
            loading: loadingDrivers.value
          }, null, 8, ["modelValue", "drivers", "loading"])) : createCommentVNode("", true),
...
//# sourceMappingURL=UploadSales-BhvneSWY.js.map
