      ...
      <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        <div class="bg-white rounded-lg shadow p-1 flex w-full sm:w-auto">
          <button 
            ...
            :class="activeFilter === filter.value ? 'bg-orange-100 text-orange-700' : 'text-gray-600 hover:bg-gray-50'"
          >
            {{ filter.label }}
          </button>
        </div>
        ...
        <div class="w-full sm:w-auto">
          <select 
            ...
            class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm rounded-md shadow-sm"
          >
...
const transactionsResource = createResource({
  url: 'custom_erp.api.fonepay.get_previous_transactions_padmashree',
  auto: false,
})
